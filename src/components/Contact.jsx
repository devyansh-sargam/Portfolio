...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const templateParams = {
      ...
      to_email: 'workdevyanshsargam@gmail.com',
      date_time: formattedDate,
      user_login: 'devyanshsargam'
    };
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:workdevyanshsargam@gmail.com" className="text-muted hover:text-light transition-colors">
                    workdevyanshsargam@gmail.com
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex gap-3 mt-2">
                    {/* GitHub */}
                    <a href="https://github.com/devyansh-sargam/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/devyanshsargam/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
